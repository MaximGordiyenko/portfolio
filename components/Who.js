    ...
    <div
      ...
      <div>
        <h1 data-scroll="" data-scroll-speed="0.5" className="title text-[40px]">
          ...
          <span className="text-cyan-700">y</span> <span className="text-cyan-800">about <span className='underline decoration-pink-500'>me</span> </span>
        </h1>
        <div data-scroll="" className="text-lg text-gray-200" id="story">
          {data.about}
          <ul>
            <li>JavaScript <span className='text-sky-600'>|</span> React <span className='text-sky-600'>|</span> React-Hooks: <span className='text-pink-400 italic'>
            ...
            <li>NextJS <span className='text-sky-600'>|</span> React-Testing-Library: <span className='text-pink-400 italic'>
              {calcDate("01/03/2022", Date.now())}
            </span>
            </li>
            <li>NodeJS <span className='text-sky-600'>|</span> MongoDB <span className='text-sky-600'>|</span> TypeScript: <span className='text-pink-400 italic'>
